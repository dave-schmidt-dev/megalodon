...
- [bug] Governor Bash policy allowed ~33 sandbox escapes — arbitrary code exec + writes/deletes outside `project_dir` | files: megalodon_ui/governor/policy.py, scripts/tests/test_governor_redteam.py | inv: INV-4
