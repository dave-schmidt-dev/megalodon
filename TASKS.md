> **Active plan: `~/Documents/Projects/.plans/megalodon/governor-hook-permission-architecture-2026-05-25-tasks.md`** (warp-tier, planned 2026-05-25; not yet executed). Governor `PreToolUse` hook replaces the screen-scraping permission system; decommissions `permission_watcher.py`. Supersedes the §1b auto-approver.
>
